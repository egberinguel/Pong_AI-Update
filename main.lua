...
function love.load()
    ...
    love.window.setTitle('Pong by Group 8')

    math.randomseed(os.time())
    vsmallFont = love.graphics.newFont('font.ttf', 6)
    ...
    sounds = {
        ...
        ['bgm'] = love.audio.newSource('sounds/bg_music.mp3','stream')
    }
...
function love.draw()
    ...
    love.graphics.setFont(largeFont)
     ...
     elseif gameState == 'menu_mode' then
        ...
        love.graphics.printf('Welcome to Pong',0, 10, VIRTUAL_WIDTH, 'center')
        love.graphics.setFont(smallFont)
        love.graphics.printf('Choose a mode. Press the corresponding number on your keyboard.',0, 30, VIRTUAL_WIDTH, 'center')
        love.graphics.setFont(smallFont)
